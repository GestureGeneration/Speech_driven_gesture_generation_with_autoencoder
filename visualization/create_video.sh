...
input_gesture_file='../evaluation/data/original/gesture1.txt'
output_video='original_1_first_20s.mp4'
...
ffmpeg -i 'data/temp_gesture_video.mp4' -i audio_segment.wav -c:v copy -map 0:v:0 -map 1:a:0 -c:a aac -b:a 192k $output_video
